...
import { TableTopupUser } from '../../../components';

const ManagementTopup = () => {
        ...
        <>
            <div className="row g-3 mt-4 align-items-center justify-content-between">
                <div className="col-auto">
                    <h1 className="app-page-title mb-2 text-uppercase">Management Topup User</h1>
                </div>
            </div>{/*//row*/}
            ...
            <TableTopupUser tab={tab} />
        </>
    )

}

export default ManagementTopup
